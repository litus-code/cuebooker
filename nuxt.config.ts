...
export default defineNuxtConfig({
  ...
  css: [resolve('./assets/css/main.css'), resolve('./assets/css/mobile-polish.css'), resolve('./assets/css/final-mobile-fixes.css'), resolve('./assets/css/workspace-light-final.css'), resolve('./assets/css/light-headline-polish.css'), resolve('./assets/css/profile-preview-fix.css'), resolve('./assets/css/workspace-v2.css'), resolve('./assets/css/workspace-v2-polish.css'), resolve('./assets/css/workspace-v3-system.css')],
  runtimeConfig: {
    public: {
