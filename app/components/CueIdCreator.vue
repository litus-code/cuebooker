...
const copy = computed(() => props.locale === 'es' ? {
  ...
  subtitle: 'Define tu apariencia paso a paso. Cada elección construye el mismo CUE ID y mantiene una identidad coherente.',
  ...
  authored: 'Preview de identidad',
  authoredBody: 'Representación de laboratorio del CUE ID. Tus elecciones de identidad se mantienen mientras evoluciona la capa visual.',
  productionBody: 'Representación visual disponible para esta configuración.',
  ...
  subtitle: 'Define your appearance step by step. Every choice builds the same CUE ID and keeps one coherent identity.',
  preview: 'Preview',
  save: 'Save CUE ID',
  reset: 'Reset',
  base: 'Base',
  ...
  authored: 'Identity preview',
  authoredBody: 'Lab representation of the CUE ID. Your identity choices remain stable while the visual layer evolves.',
  productionBody: 'Visual representation available for this configuration.',
