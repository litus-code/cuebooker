...
<template>
  <section class="artist-workspace-profile">
    ...
    <article class="artist-workspace-profile__portfolio">
      ...
      <section class="artist-workspace-profile__passport">
        <div class="artist-workspace-profile__section-label"><span>03</span><strong>CUE PASSPORT</strong></div>
        <div class="artist-workspace-profile__passport-content">
