...
.cue-segmented { display: flex; gap: 2px; padding: 3px; border: 1px solid var(--cue-border); border-radius: 999px; background: #0d0d0d; }
.cue-segmented button { min-width: 34px; min-height: 32px; padding: 0 9px; border: 0; border-radius: 999px; background: transparent; color: #949494; cursor: pointer; font-size: 9px; font-weight: 900; }
.cue-segmented button.active { background: var(--cue-toggle); color: #070707; box-shadow: 0 0 18px color-mix(in srgb, var(--cue-toggle) 28%, transparent); }
.cue-theme-toggle { width: 40px; height: 40px; padding: 9px; border: 1px solid var(--cue-border); border-radius: 50%; background: #0d0d0d; color: #949494; cursor: pointer; }
...
.cue-theme-toggle span::after { position: absolute; top: -18%; left: 42%; width: 100%; height: 100%; border-radius: 50%; background: #0d0d0d; content: ''; }
