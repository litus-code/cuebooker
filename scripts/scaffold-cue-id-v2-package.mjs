...
if (!version) {
  console.error('Usage: node scripts/scaffold-cue-id-v2-package.mjs --version <x.y.z> [--output-dir <path>]')
  process.exit(1)
}

try {
  const result = await scaffoldCueIdV2Package(outputDir, version)
